      ...
      while (players[i].turn) {
        ...
        if (players[i].jail == true) {
          ...
          if (players[i].token.position[0] == 0) { //This entire if, else if, else statement moves the player's piece
            if (players[i].token.position[1] - (diceroll[0].getValue() + diceroll[1].getValue()) < 0) {
              players[i].token.position[0] = (diceroll[0].getValue() + diceroll[1].getValue()) - players[i].token.position[1];
              players[i].token.position[1] = 0;
            } else {
              players[i].token.position[1] = players[i].token.position[1] - (diceroll[0].getValue() + diceroll[1].getValue());
            }
          } else if (players[i].token.position[0] == 9) {
            if (players[i].token.position[1] + (diceroll[0].getValue() + diceroll[1].getValue()) > 9) {
              players[i].token.position[0] = 9 - ((diceroll[0].getValue() + diceroll[1].getValue()) - (9 - players[i].token.position[1]));
            ...
            if (players[i].token.position[1] == 9) {
              if (players[i].token.position[0] - (diceroll[0].getValue() + diceroll[1].getValue()) < 0) {
                players[i].token.position[1] = 9 - ((diceroll[0].getValue() + diceroll[1].getValue()) - players[i].token.position[0]);
                players[i].token.position[0] = 0;
              } else {
                players[i].token.position[0] = players[i].token.position[0] - (diceroll[0].getValue() + diceroll[1].getValue());
              }
            } else {
              if (players[i].token.position[0] + (diceroll[0].getValue() + diceroll[1].getValue()) > 9) {
                players[i].token.position[1] = (diceroll[0].getValue() + diceroll[1].getValue()) - (9 - players[i].token.position[0]);
...
bool roll(Dice diceroll[]) {
  ...
  if (diceroll[0].getValue() == diceroll[1].getValue()) turn = true;
  else turn = false;
